...
-(id)initWithFrameRect:(CGRect)rect ImageArray:(NSArray *)imgArr TitleArray:(NSArray *)titArr
{
	...
	if ((self=[super initWithFrame:rect])) {
        ...
        for (int i=0; i<pageCount; i++) {
            ...
            UrlImageView *imgView=[[[UrlImageView alloc] init] autorelease];
        ...
        //说明文字层
        UIView *noteView=[[UIView alloc] initWithFrame:CGRectMake(0, self.bounds.size.height-33,self.bounds.size.width,40)];
        ...
        _coustomPageControl.frame = CGRectMake((self.frame.size.width-pageControlWidth)/2,2, pageControlWidth, pagecontrolHeight);
        ...
        _coustomPageControl.numberOfPages=(pageCount-2);
        ...
        [noteView addSubview:_coustomPageControl];
...
- (void)scrollViewDidScroll:(UIScrollView *)sender
{
    ...
    self.coustomPageControl.currentPage=(page-1);
