...
@interface RMDownloadIndicatorTwo()
...
@implementation RMDownloadIndicatorTwo
...
- (void)addLabel
{
    ...
    [self addSubview:jixiaoLabel];
    
    
    UILabel* moneyLabel = [[UILabel alloc]init];
    moneyLabel.frame = CGRectMake(CGRectGetMinX(jixiaoLabel.frame)+5, CGRectGetMaxY(jixiaoLabel.frame),70, 30);
    moneyLabel.font = [UIFont systemFontOfSize:16];
    moneyLabel.text = @"2000元";
    moneyLabel.textColor =[UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:1.0];
    ...
    percentLabel.text = [NSString stringWithFormat:@"占比%d%%",80];
    percentLabel.textColor =[UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:1.0];
...
- (void)initAttributes
{
    ...
    if(_type == kRMClosedIndicator)
    {
        ...
        _closedIndicatorBackgroundStrokeColor = [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0.25];
        _coverWidth = 1.5;
