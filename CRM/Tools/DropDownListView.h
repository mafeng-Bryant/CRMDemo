...
@protocol changeDataSourceDelegate <NSObject>
...
@property(nonatomic,assign) KChangeType type;
@property(nonatomic,assign) id<changeDataSourceDelegate> dataSourceDelegate;
