...
//        self.lastUpdateTime = [[NSUserDefaults standardUserDefaults] objectForKey:MJRefreshHeaderTimeKey];
        if (self.timeKey == nil) {
            self.timeKey = MJRefreshHeaderTimeKey;
        }
        self.lastUpdateTime = [[NSUserDefaults standardUserDefaults] objectForKey:self.timeKey];
    }
...
//    [[NSUserDefaults standardUserDefaults] setObject:lastUpdateTime forKey:MJRefreshHeaderTimeKey];
    [[NSUserDefaults standardUserDefaults] setObject:lastUpdateTime forKey:self.timeKey];
